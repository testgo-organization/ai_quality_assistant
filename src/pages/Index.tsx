      ...
      <footer className="relative py-8 px-4 sm:px-6 lg:px-8 z-10 bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">PIACC</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Plataforma Inteligente de Análisis de Contacto Cliente
              </p>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-piacc-blue">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-piacc-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>contacto@piacc.com</span>
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-piacc-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li><a href="#" className="hover:text-piacc-blue">Inicio</a></li>
                <li><a href="#" className="hover:text-piacc-blue">Características</a></li>
                <li><a href="#" className="hover:text-piacc-blue">Precios</a></li>
                <li><a href="#" className="hover:text-piacc-blue">Documentación</a></li>
                <li><a href="#" className="hover:text-piacc-blue">Blog</a></li>
              </ul>
            </div>
          </div>
